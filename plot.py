...
fig.suptitle("Tent map", fontsize=18, fontweight='bold')
...
ax[1,0].set_xlabel("Amplitude $y_1$")
ax[1,0].set_ylabel(r"Densidade de $y_1$")

ax[1,1].hist(T[1,:], density=True, bins='fd')
ax[1,1].set_title("Histogram Y2")
ax[1,1].set_xlabel("Amplitude $y_2$")
ax[1,1].set_ylabel(r"Densidade de $y_2$")
...
fig.suptitle("WGC map", fontsize=18, fontweight='bold')
