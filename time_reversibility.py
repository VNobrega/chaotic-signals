...
signal_rev = np.array([time_reversibility_stat(plotfile.W[0,:]), time_reversibility_stat(plotfile.W[1,:])])
...
print("signal: {:.5f}".format(signal_rev[0]),",{:.5f}".format(signal_rev[1]))
